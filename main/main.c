...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "Allocate separate LVGL draw buffers from PSRAM, available %d DMA capable %d, requesting %d", heap_caps_get_free_size(MALLOC_CAP_8BIT), heap_caps_get_free_size(MALLOC_CAP_DMA), buf1size);
